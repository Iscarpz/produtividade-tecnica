export const OPEN_STATUSES = ["EM ANDAMENTO", "AGUARDANDO PP", "AGUARDANDO ORÇAMENTO", "Zurich"] as const;
export const PRODUCTIVITY_EVENTS = ["RECEBIDO", "FINALIZADO", "ENVIADO_PP", "ENVIADO_ORCAMENTO", "ENVIADO_Zurich"] as const;
